# app_tavily_fixed.py
"""
EvoGen AI with Tavily integration (修正版)

使い方:
  - 必要ライブラリ:
      pip install streamlit requests google-generativeai
  - 実行:
      streamlit run app_tavily_fixed.py
"""
                    ...
                    with results_area.container():
                        ...
                        with st.container(border=True):
                            ...
                            for item in gen_data.get('results', []):
                                ...
                                content = sol.get('specific_method', 'N/A') # 'summary' から変更
                                st.markdown(f"**具体的な方法:** {content}") # 「内容」から変更
